...
import org.jboss.hal.testsuite.page.config.ReplicatedCachePage;
...
public class ReplicatedCacheTestCase {
    ...
    private static final String CACHE_DMR = (ConfigUtils.isDomain() ? DOMAIN_CACHE_CONTAINER_ADDRESS : CACHE_CONTAINER_ADDRESS) + "=" + CACHE_CONTAINER + "/replicated-cache=" + CACHE_NAME;
    ...
    @Page
    public ReplicatedCachePage page;

    @Before
    public void before() {
        browser.navigate().refresh();
        Graphene.goTo(ReplicatedCachePage.class);
