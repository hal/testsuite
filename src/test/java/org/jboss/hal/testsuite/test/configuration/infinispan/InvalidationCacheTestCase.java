...
public class InvalidationCacheTestCase {
    ...
    private static final String CACHE_DMR = (ConfigUtils.isDomain() ? DOMAIN_CACHE_CONTAINER_ADDRESS : CACHE_CONTAINER_ADDRESS) + "=" + CACHE_CONTAINER + "/invalidation-cache=" + CACHE_NAME;
