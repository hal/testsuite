...
public class DistributedCacheTestCase {
    ...
    private static final String DMR_BASE = (ConfigUtils.isDomain() ? DOMAIN_CACHE_CONTAINER_ADDRESS : CACHE_CONTAINER_ADDRESS) + "=" + CACHE_CONTAINER + "/distributed-cache=";
    ...
    @Page
    public DistributedCachePage page;

    @Before
    public void before() {
        addCache();
        browser.navigate().refresh();
        Graphene.goTo(DistributedCachePage.class);
